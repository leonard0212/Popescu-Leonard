...
// Verificăm dacă venim din pagina de înregistrare (signup.php)
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 1. ÎNCERCĂM SĂ AUTENTIFICĂM CA ADMIN
    ...
    if ($result->num_rows === 1) {
        ...
        // 2. DACĂ NU E ADMIN, ÎNCERCĂM CA CLIENT
        // (Doar dacă ai rulat SQL-ul care adaugă password_hash la clienți)
        
        // Verificăm dacă există coloana password_hash în clienți pentru a evita erori dacă nu ai updatat baza
        ...
        if($check_col->num_rows > 0) {
            ...
            if ($result_client->num_rows === 1) {
                ...
                // Verificăm dacă clientul are parolă setată
            ...
            // Dacă nu avem suport pentru login clienți încă
...
<body id="top">
    <div class="form-container animate-on-scroll">
        <div style="text-align: center; margin-bottom: 1.5rem;">
            <a href="index.php">
                <img src="assets/images/logo.png" alt="ServiceFlow Logo" style="height: 60px;">
            </a>
        </div>
        <h1>Autentificare</h1>
